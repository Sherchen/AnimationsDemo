...
import com.sherchen.common.util.IOUtils;
import com.sherchen.common.util.StringUtils;
import com.sherchen.common.util.Utils;
import com.sherchen.wanjiedemo.camera.model.PhotoItem;
...
public class FileUtils {
    ...
    public String readFromAsset(String fileName) {
        ...
        try {
            is = Utils.getContext().getAssets().open(fileName);
