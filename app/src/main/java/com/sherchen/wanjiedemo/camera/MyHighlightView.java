...
import com.sherchen.common.util.SizeUtils;
import com.sherchen.wanjiedemo.R;
import com.sherchen.wanjiedemo.WanjieApp;
import com.sherchen.wanjiedemo.camera.drawable.EditableDrawable;
import com.sherchen.wanjiedemo.camera.drawable.FeatherDrawable;
...
public class MyHighlightView implements EditableDrawable.OnSizeChange {
    ...
    public void setScaleable(boolean scaleable) {
        ...
        if (scaleable) {
            mAnchorRotate = WanjieApp.getInstance().getResources().getDrawable(R.drawable.aviary_resize_knob);
        } else {
            mAnchorRotate = null;
        }
    }
    ...
    public void setDeleteable(boolean deleteable) {
        if (deleteable) {
            mAnchorDelete = WanjieApp.getInstance().getResources().getDrawable(R.drawable.aviary_delete_knob);
        } else {
            mAnchorDelete = null;
        }
    }
